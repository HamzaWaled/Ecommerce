...
<div class="limiter" id="login">
    <div class="container-login100" style="background-image:url(https://www.dynamique-mag.com/wp-content/uploads/media-aujourdhui-tendances-commerce-les-du.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-md-6"></div>
                <div class="col-md-5 col-md-offset-1">
                    <div class="login_topimg"> <img src="../../../../../../dist/img/ecommerce.png" style="height: 200px; width: 270px; margin-left: 80px; border-top-left-radius: 30px;
                    ...
                    <div class="wrap-login100">
                          ...
                          <form action="{{route('login_post')}}" method="post" class="login100-form validate-form">
                            ...
                            <div class="container-login100-form-btn p-t-25"> 
                                ...
                                <div><br><a href="{{route('Register_page')}}">You don't have an account?</a></div>
                        </form>
                    </div>
                </div>
            </div>
